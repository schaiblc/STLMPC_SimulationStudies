...
\scriptsize $d_\textup{safe}$ & \scriptsize Gap hazard threshold (m) & \scriptsize 2 & \scriptsize 1.25 \\
...
\scriptsize $d_\textup{stop}$ & \scriptsize Supervisory stopping distance (m) & \scriptsize --- & \scriptsize 0.5 \\
